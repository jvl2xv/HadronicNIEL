...
{
  public:
    B4RunAction(int numMaterial, int numDimension);
    virtual ~B4RunAction();

    virtual void BeginOfRunAction(const G4Run* run);
    virtual void   EndOfRunAction(const G4Run* run);

    std::vector<double> NIEL_Total_keV;
    std::vector<double> NIEL_Coulomb_keV;
    std::vector<double> NIEL_HadronInel_keV;
    std::vector<double> NIEL_HadronEl_keV;
