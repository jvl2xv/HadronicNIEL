...
public:
     ...
     G4ScreenedNuclearRecoil(const G4String& processName = "ScreenedElastic",
                const G4String &ScreeningKey="zbl", G4bool GenerateRecoils=true, 
                G4double RecoilCutoff=100.0*eV, G4double PhysicsCutoff=10.0*eV); // tried reducing recoil cutoff to 10eV, made it worse
