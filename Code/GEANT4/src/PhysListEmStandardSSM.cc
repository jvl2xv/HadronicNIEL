...
void PhysListEmStandardSSM::ConstructProcess()
{
  ...
  while( (*particleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      G4CoulombScattering* cs = new G4CoulombScattering();
      G4IonCoulombScatteringModel* ion_cs = new G4IonCoulombScatteringModel();
      ion_cs->SetRecoilThreshold(0.0*eV);
      cs->AddEmModel(0, ion_cs);
      ...
      G4CoulombScattering* cs = new G4CoulombScattering();
      G4IonCoulombScatteringModel* ion_cs = new G4IonCoulombScatteringModel();
      ion_cs->SetRecoilThreshold(5.0*eV);
      cs->AddEmModel(0, ion_cs);
      cs->SetBuildTableFlag(true);
      pmanager->AddDiscreteProcess(cs);
